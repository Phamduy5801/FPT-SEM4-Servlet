...
<div class="container">
    ...
    <form action="NhaXuatBan" method="post">
        ...
        <div class="form-group">
            <label>Name: </label>
            <input type="text"  class="form-control" id="name" name="ten" value="<%= nhaXuatBan.getTen() %>" >
        </div>
        <div class="form-group">
            <label>Address: </label>
            <input type="text"  class="form-control" id="address" name="diachi" value="<%= nhaXuatBan.getDiachi() %>">
        </div>
        <div class="form-group">
            <label>Telephone: </label>
            <input type="text"  class="form-control" id="telphone" name="sdt" value="<%= nhaXuatBan.getSdt() %>">
        </div>
        <div class="form-group">
            <label>Fax: </label>
