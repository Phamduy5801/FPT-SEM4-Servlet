...
<div class="container">
    ...
    <form action="CuaHang" method="post">
        ...
        <div class="form-group">
            <label>Name: </label>
            <input type="text" readonly class="form-control" id="name" name="ten" value="<%= cuaHang.getTen() %>" >
        </div>
        <div class="form-group">
            <label>Address: </label>
            <input type="text" readonly class="form-control" id="address" name="diachi" value="<%= cuaHang.getDiaChi() %>">
        </div>
        <div class="form-group">
            <label>Telephone: </label>
            <input type="text" readonly class="form-control" id="telphone" name="sdt" value="<%= cuaHang.getSdt() %>">
        </div>
        <div class="form-group">
            <label>Fax: </label>
